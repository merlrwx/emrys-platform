...
resource "azurerm_kubernetes_flux_configuration" "main" {
  ...
  kustomizations {
    ...
    path                       = "./gitops/infrastructure/controllers/staging"
  ...
  kustomizations {
    name                       = "infra-configs"
    path                       = "./gitops/infrastructure/configs/staging"
    sync_interval_in_seconds   = 300
  ...
  kustomizations {
    name                       = "cnpg-plugin"
    path                       = "./gitops/infrastructure/cnpg-plugin/staging"
    sync_interval_in_seconds   = 300
  ...
  kustomizations {
    ...
    path                       = "./gitops/monitoring/controllers/staging"
    sync_interval_in_seconds   = 300
    depends_on                 = ["apps"]
    garbage_collection_enabled = true
  }
  ...
  kustomizations {
    ...
    path                       = "./gitops/monitoring/configs/staging"
    sync_interval_in_seconds   = 300
